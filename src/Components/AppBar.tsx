...
import { truncateAddress, networkName, hexToRgbA } from '../utils';
...
export default function TopAppBar({onboard}:{onboard: any}) {
  ...
  createStyles({
    ...
    addressBtn: {
      background: globalState.darkmode ? theme.palette.primary.main : hexToRgbA(theme.palette.primary.main, 0.5),
      textTransform: 'none',
      borderRadius: 30,
      borderColor: 'none',
      lineHeight: 1.4,
